...
const PRODUCTS = [
  {
    ...
    tagline: "Smooth, Clean & Reliable Barrier Packaging",
    art: "roll-art--cream",
    arm: "Both",
    featured: true,
    construction: "Highly calendered glassine base with optional PE coating",
    desc: "Glassine Paper is a smooth, highly calendered paper known for its excellent surface finish, strength and clean appearance. It is widely used where a smooth paper surface and reliable protection are important.",
    applications: ["Pharmaceutical and medical packaging", "Soap and cosmetic wrapping", "Food and confectionery packaging", "Protective and wrapping applications"],
    properties: ["Smooth and uniform surface", "Good printability", "Available in different GSM options", "PE coating available as required", "Suitable for customized packaging structures"],
    variants: ["Plain Glassine", "PE Coated Glassine", "Printed Glassine", "Customized GSM and reel widths"],
    coatings: ["PE coating"],
    specs: { finish: "Smooth, highly calendered", coating_type: "PE coating available as required", packaging_applications: "Pharma / Medical / Food / FMCG" },
    certs: ["FSC", "FDA"],
  ...
  },
  {
    ...
    tagline: "Strong Surface, Excellent Finish & Reliable Performance",
    art: "roll-art--kraft",
    arm: "Manufactured",
    featured: true,
    construction: "Machine-glazed poster paper base with optional PE coating",
    desc: "MG Poster Paper is manufactured with a machine-glazed surface that provides a smooth and attractive finish. It is suitable for packaging and printing applications where appearance, consistency and handling strength are important.",
    applications: ["Primary and secondary packaging", "Printed wrappers", "Food and FMCG packaging", "Promotional and retail packaging"],
    properties: ["Smooth glazed surface", "Good printing performance", "Consistent paper quality", "Suitable for coating and lamination", "Available in customized specifications"],
    variants: ["Different GSM grades", "PE coated", "Printed", "Roll and sheet formats"],
    coatings: ["PE coating", "Lamination"],
    specs: { coating_type: "PE coating available", finish: "Smooth machine-glazed surface", packaging_applications: "Food / FMCG / Retail / Industrial" },
    certs: [],
  ...
  },
  {
    ...
    tagline: "A Premium Surface for High-Quality Printing",
    art: "roll-art--cream",
    arm: "Manufactured",
    featured: true,
    construction: "Chromo base with smooth coated surface and optional lamination",
    desc: "Chromo Paper offers a smooth, coated surface designed for applications where print quality and presentation matter. Its uniform surface helps produce sharp graphics and an attractive finished package.",
    applications: ["Product labels", "Printed packaging", "Pharmaceutical and FMCG packaging", "Promotional packaging", "Retail applications"],
    properties: ["Smooth printable surface", "Good appearance", "Suitable for high-quality printing", "Can be coated or laminated according to application"],
    variants: ["Different GSM", "Coated and laminated structures", "Printed or unprinted", "Customized reel widths"],
    coatings: ["Coated", "Laminated"],
    specs: { gsm: "Different GSM options", finish: "Smooth coated surface", packaging_applications: "Pharma / FMCG / Retail / Printing" },
    certs: [],
    industries: ["fmcg"],
  ...
  },
  {
    ...
    tagline: "Strength with a Smooth, Professional Finish",
    art: "roll-art--kraft",
    arm: "Both",
    featured: true,
    construction: "Kraft base with smooth machine-glazed surface and optional coating",
    desc: "MG Kraft Paper combines the natural strength of kraft paper with a smooth machine-glazed surface. It is a practical choice for packaging applications requiring strength, appearance and reliable converting performance.",
    applications: ["Bags and wrappers", "Industrial packaging", "Food packaging", "FMCG applications", "General-purpose wrapping"],
    properties: ["Good tensile strength", "Smooth surface", "Suitable for printing", "Available for coating and lamination", "Flexible for customized packaging requirements"],
    variants: ["Various GSM grades", "Brown and other available shades", "PE coated", "Printed and laminated"],
    coatings: ["PE coating", "Lamination"],
    specs: { gsm: "Various GSM grades", finish: "Smooth machine-glazed surface", packaging_applications: "Food / FMCG / Industrial / Retail" },
    certs: [],
    industries: ["food-beverage", "fmcg"],
  ...
  },
  {
    ...
    tagline: "Reliable Kraft Paper for Everyday Packaging",
    art: "roll-art--kraft",
    arm: "Distributed",
    featured: false,
    construction: "Machine-finished kraft paper with optional coating",
    desc: "MF Kraft Paper provides a dependable balance of strength, surface quality and converting performance. It is suitable for customers looking for economical and practical paper solutions for packaging.",
    applications: ["Wrapping", "Bags", "Industrial packaging", "Food and FMCG applications", "Lamination structures"],
    properties: ["Reliable paper strength", "Good runnability", "Suitable for printing and coating", "Available in different GSM options", "Can be supplied as per application requirement"],
    variants: ["Different GSM", "Plain or printed", "PE coated", "Laminated structures"],
    coatings: ["PE coating", "Lamination"],
    specs: { gsm: "Different GSM options", finish: "Machine finished", packaging_applications: "Industrial / Food / FMCG / Retail" },
    certs: [],
    industries: ["food-beverage", "fmcg"],
    cats: { construction: "single", coating: "uncoated", fn: ["printable"] }
  },
  ...
  },
  {
    ...
    name: "Grid Extrusion Coated Paper",
    aka: "Grid Lacquer",
    tagline: "Breathable grid extrusion coated medical paper for heat-seal sterile packs.",
    art: "roll-art",
    arm: "Manufactured",
    featured: false,
    construction: "Paper + grid coating",
    desc: "Grid Extrusion Coated Paper is medical grade packaging paper with heat-sealable lacquer applied in a grid pattern. It is sterilization-compatible, supports fibre-free peeling and stays breathable because gases can pass through the open grid lines.",
